        ...
        <div className="modal-overlay">
          <div className="modal__delete">
            ...
            <div className="p-4 md:p-5 text-center">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Êtes-vous sûr de vouloir supprimer ces enregistrement ?</h3>
                <button 
