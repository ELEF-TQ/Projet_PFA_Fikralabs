...
//   return (
//     <div className="flex flex-col md:flex-row justify-between items-center bg-gray-100 rounded-lg p-2 mb-2 w-full md:w-4/5">
//       <div className="flex items-center mb-4 md:mb-0">
//         <img src={image} alt={conversion.status} className="w-10 h-10 mr-4" />
//         <div className="flex flex-col">
//           <span className="text-lg font-semibold mb-1 md:mb-0"> <span className=" font-light">#{conversion.Num_Demande}</span> - {conversion.montant} DH</span>
//           <span className="text-lg font-light">12/20/2024</span>
//         </div>
//       </div>
//       <button onClick={handleOpenModal}>
