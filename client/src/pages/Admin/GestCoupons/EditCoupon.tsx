...
import { fetchAllCoupons, updateCoupon } from '../../../context/features/CouponSlice';
...
const EditCoupon: React.FC<Props> = ({ show, handleClose, Element }) => {
  ...
  useEffect(() => {
    ...
    const handleSubmit = () => {
        ...
        dispatch(updateCoupon({ id: Element._id, formData })).then(() => {
            handleClose();
