...
import { fetchPompistes } from '../../../context/features/PompisteSlice';
...
const Pompiste: React.FC = () => {
  ...
  const { pompistes, loading } = useSelector((state: any) => state.pompistes);
  ...
  return (
    <div>
      <h1 className="text-4xl font-bold mb-8"> Gestion des Pompistes</h1>
      {loading ? (
       <Spinner/>
      ) : (
          ...
          <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              <div className="flex-1 flex items-center space-x-2">
                <h5>
                  <span className="dark:text-white text-black">Tous les pompistes : </span>
                  <span className="dark:text-white text-black"> {pompistes.length}</span>
                </h5>
      ...
      <Destroy
        ...
        onDestroySuccess={fetchPompistes}
      />
      <Delete
        ...
        Id={selectedId}
        EndPoint="/pompistes"
        onDeletionSuccess={fetchPompistes}
      />
